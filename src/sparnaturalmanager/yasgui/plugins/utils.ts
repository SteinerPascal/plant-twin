/*
    This class is copied from Yasgui.yasgui-utils.index.ts
    It's copied because react cra doesn't compile source files outside of it's own dir.
    This class is used by the CustomTable.ts component which is also copied and slightly manipulated
*/
